...
Filter_V2.0.py
Usage:
	Filter_V2.0.py Shared_reciprocated_blast_hits_SingleCopyOrthogroups_parser_FullDescription.txt
"""

import sys,os,re

InFileName = sys.argv[1]
OutFileName = os.path.splitext(InFileName)[0] + '_filtered_2.0.txt'
...
if len(sys.argv) < 2:
	...
	for Line in InFile:
		...
		if P_VAL <= 1e-10 and Identity >= 80 and AlignmentLength >= 200:
			OutFile.write(Line + "\n")
	InFile.close()
OutFile.close()

...
proc import OUT=WORK.&reads._&rep._2_&ref._&alt 
            DATAFILE="/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Polyploid_alignment/Compare_SAM/ase_counts_rename/ase_counts_&reads._&rep._2_&ref._&alt..csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
     GUESSINGROWS=20; 
...
%import_cnts (Tml, 1, tdu, tpr) ;
%import_cnts (Tml, 2, tdu, tpr) ;
%import_cnts (Tml, 3, tdu, tpr) ;

data trago.ase_4_bayes_Tms_reads_tdu_tpr ;
set ase_Tms_1_tdu_tpr ase_Tms_2_tdu_tpr ase_Tms_3_tdu_tpr;
run ;

data trago.ase_4_bayes_Tml_reads_tdu_tpr ;
set ase_Tml_1_tdu_tpr ase_Tml_2_tdu_tpr ase_Tml_3_tdu_tpr;
run ;

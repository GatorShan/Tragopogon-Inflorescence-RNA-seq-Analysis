...
%macro import_bayesian (hybrid) ;
     ...
     infile "/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Polyploid_alignment/empirical_bayesian_hybrids_output/PG_emp_bayesian_results_&hybrid._hybrid.csv"

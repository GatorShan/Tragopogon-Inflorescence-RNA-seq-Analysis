...
#SBATCH --job-name=Polyploid_alignment_filter_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Polyploid_alignment_filter_V1_%j.out
#SBATCH --error=Polyploid_alignment_filter_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
IN=/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Polyploid_alignment

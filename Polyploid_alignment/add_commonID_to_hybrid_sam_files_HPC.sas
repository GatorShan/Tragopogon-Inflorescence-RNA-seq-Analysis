...
%macro add_commonid (reads, rep, ref, alt);
     ...
     infile  "/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Polyploid_alignment/Filter_SAM_by_bed/&reads._&rep._uniq_2_&ref._filter_for_Poly.sam"
...
outfile= "/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Polyploid_alignment/Filter_SAM_by_bed/&reads._&rep._unq_2_&ref._commonID.sam"
dbms=tab replace ; 
putnames = no ;
run;
%mend ;

...
#SBATCH --job-name=SAM_filter_by_bed_poly_newASE_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=SAM_filter_by_bed_poly_newASE_V1_%j.out
#SBATCH --error=SAM_filter_by_bed_poly_newASE_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1

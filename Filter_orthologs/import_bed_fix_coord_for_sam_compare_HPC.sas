...
data WORK.bed_&ONE._&TWO    ;
     ...
     infile "/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Filter_orthologs/Filter_SAM_by_bed/&ONE.-&TWO._overlaps_orthologs.csv" delimiter = ','
...
outfile ='/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Filter_orthologs/Filter_SAM_by_bed/TDU_tpr_bed_for_sam_compare.bed'
dbms=tab replace ;
run;
...
outfile ='/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Filter_orthologs/Filter_SAM_by_bed/TPR_tdu_bed_for_sam_compare.bed'
dbms=tab replace ;
run;

...
proc import OUT=WORK.&reads&rep._2_&ref._&alt 
            DATAFILE="/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Filter_orthologs/Compare_SAM/ase_counts_rename/ase_counts_&reads._&rep._2_&ref._&alt..csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
     GUESSINGROWS=20; 
...
%import_cnts (Tdu, 4, Tdu, Tpr) ;
%import_cnts (Tdu, 5, Tdu, Tpr) ;
%import_cnts (Tdu, 6, Tdu, Tpr) ;
...
set ase_Tdu1_Tdu_Tpr ase_Tdu2_Tdu_Tpr ase_Tdu3_Tdu_Tpr ase_Tdu4_Tdu_Tpr ase_Tdu5_Tdu_Tpr ase_Tdu6_Tdu_Tpr;
run ;

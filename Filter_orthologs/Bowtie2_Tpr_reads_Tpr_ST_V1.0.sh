...
#SBATCH --job-name=Bowtie2_Tpr_reads_Tpr_ST_V1.0
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Bowtie2_Tpr_reads_Tpr_ST_V1.0_%j.out
#SBATCH --error=Bowtie2_Tpr_reads_Tpr_ST_V1.0_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
bowtie2 \
	...
	-S ${OUT}/Tpr_reads_Tpr_ST_V1.sam

echo "Tpr reads have been mapped to Tpr supertranscripts"

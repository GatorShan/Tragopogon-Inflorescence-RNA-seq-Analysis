...
#SBATCH --job-name=Trinotate_Blast_Tpr_1.0
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Trinotate_Blast_Tpr_1.0_%j.out
#SBATCH --error=Trinotate_Blast_Tpr_1.0_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
IN2=/ufrc/soltis/shan158538/TragFL_NewAnalysis/OutPut/Annotation/TransDecoder/Tpr
...
blastx \
	-query ${IN1}/SuperTranscript_Tpr.fasta \
	-db ${DB}/uniprot_sprot.pep \
	-num_threads 16 \
	-max_target_seqs 1 \
	-outfmt 6 \
	-evalue 1e-3 \
	> ${OUT}/Tpr_blastx.outfmt6

echo "Search Trinity transcripts"

blastp \
	-query ${IN2}/SuperTranscript_Tpr.fasta.transdecoder.pep \
	-db ${DB}/uniprot_sprot.pep \
	-num_threads 16 \
	-max_target_seqs 1 \
	-outfmt 6 \
	-evalue 1e-3 \
	> ${OUT}/Tpr_blastp.outfmt6

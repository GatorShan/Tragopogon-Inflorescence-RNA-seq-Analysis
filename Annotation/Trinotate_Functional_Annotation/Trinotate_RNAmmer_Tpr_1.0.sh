...
#SBATCH --job-name=Trinotate_RNAmmer_Tpr_1.0
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Trinotate_RNAmmer_Tpr_1.0_%j.out
#SBATCH --error=Trinotate_RNAmmer_Tpr_1.0_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
/apps/trinotate/3.0.1/util/rnammer_support/RnammerTranscriptome.pl \
	--transcriptome ${IN}/SuperTranscript_Tpr.fasta \

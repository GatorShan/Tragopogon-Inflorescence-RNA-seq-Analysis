...
#SBATCH --job-name=Trinotate_SignalP_Tdu_1.0
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Trinotate_SignalP_Tdu_1.0_%j.out
#SBATCH --error=Trinotate_SignalP_Tdu_1.0_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
signalp \
	-fasta ${IN}/SuperTranscript_Tdu.fasta.transdecoder.pep

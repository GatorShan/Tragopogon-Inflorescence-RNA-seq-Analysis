...
#SBATCH --job-name=blastn_mito-interaction_Tdu_4957.V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=blastn_mito-interaction_Tdu_4957.V1_%j.out
#SBATCH --error=blastn_mito-interaction_Tdu_4957.V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
blastn \
	...
	-perc_identity 85 \
	-qcov_hsp_perc 50 \
	-out blastn_Mito-interaction_TduSuperTranscripts_E10_I85_P50.txt

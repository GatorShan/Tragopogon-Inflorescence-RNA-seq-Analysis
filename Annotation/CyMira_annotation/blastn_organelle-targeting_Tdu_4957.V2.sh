...
#SBATCH --job-name=blastn_organelle-targeting_Tdu_4957.V2
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=blastn_organelle-targeting_Tdu_4957.V2_%j.out
#SBATCH --error=blastn_organelle-targeting_Tdu_4957.V2_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
blastn \
	...
	-perc_identity 80 \
	-qcov_hsp_perc 30 \
	-out blastn_organelle-targeting_TduSuperTranscripts_E5_I80_P30.txt
